...
Feature-boundary questions refer to the historical release described inside the
fixed corpus. They intentionally do not track current runtime capabilities.
